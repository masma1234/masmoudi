      ...
      <section className="relative h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Premium Hinges & Decorative Articles
          </h1>
          <p className="text-xl md:text-2xl mb-8">
            Discover our collection of high-quality hardware for your home
          </p>
          <Link
            href="/articles"
              ...
              <div key={item} className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4">
                    High-quality decorative hinge set perfect for your furniture needs.
                  </p>
                  <Link
                    href="/articles"
